...
void LoadStepValue (unsigned int);
void LoadDeadTimeValue (unsigned int);
void LoadTorqueValue (unsigned int);
void LoadOffTimeValue (unsigned int);
void LoadBlankTimeValue (unsigned int);
void LoadAdaptiveBlankingValue (unsigned int);
void LoadDecayTimeValue (unsigned int);
void LoadDecayModeValue (unsigned int);
void LoadDriveTimeLowValue (unsigned int);
void LoadDriveTimeHighValue (unsigned int);
void LoadDriveCurrentLowValue (unsigned int);
void LoadDriveCurrentHighValue (unsigned int);
# 8 "SPI.c" 2
...
void LoadStepValue (unsigned int StepValue)
{
    ...
    SPIValue = SPIValue & 0b1111111110000111;
...
void LoadDeadTimeValue (unsigned int DeadTimeValue)
{
    ...
    SPIValue = SPIValue & 0b1111001111111111;
...
void LoadAdaptiveBlankingValue (unsigned int AdaptiveBlankingValue)
{
    ...
    SPIValue = SPIValue & 0b1111111011111111;
...
void LoadDecayModeValue (unsigned int DecayModeValue)
{
    ...
    SPIValue = SPIValue & 0b1111100011111111;
...
void LoadDriveTimeLowValue (unsigned int DriveTimeLowValue)
{
    ...
    SPIValue = SPIValue & 0b1111111111001111;
...
void LoadDriveTimeHighValue (unsigned int DriveTimeHighValue)
{
    ...
    SPIValue = SPIValue & 0b1111111100111111;
...
void LoadDriveCurrentLowValue (unsigned int DriveCurrentLowValue)
{
    ...
    SPIValue = SPIValue & 0b1111110011111111;
